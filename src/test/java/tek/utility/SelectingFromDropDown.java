...
public class SelectingFromDropDown {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Option 2) to select from drop down is using value attribute of Option
        //programmingSelect.selectByValue("c++");

        //Option 3) to select from drop down is using visible text of Options
