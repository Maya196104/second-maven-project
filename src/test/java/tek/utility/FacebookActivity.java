...
public class FacebookActivity {
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("firstname"))).sendKeys("Maya");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("lastname"))).sendKeys("Alieva");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("reg_email__"))).sendKeys("maya@tekschool.us");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("reg_passwd__"))).sendKeys("Password@5555");
        ...
        yearSelect.selectByVisibleText("1961");
